...
var pausedScene = {
	setup : function( ) {
		...
		this.menu.add( ( myGameArea.canvas.width / 2 ) - 30, ( myGameArea.canvas.width / 2 ) - 40, 150, 145, "image", retry_image, retry_image_hover, function() {
		...
		this.menu.add( ( myGameArea.canvas.width / 2 ) - 45, ( myGameArea.canvas.width / 2 ) - 55, 190, 185, "image", settings_image, settings_image_hover, function() {
			GAME_STATE.change_scene( SCENES.SETTINGS_SCENE );
		} );
		this.menu.add( ( myGameArea.canvas.width / 2 ) - 30, ( myGameArea.canvas.width / 2 ) - 40, 230, 225, "image", menu_image, menu_image_hover, function() {
